...
public class BinaryTreeLevelOrderTraversal {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Test 1: " + solution.levelOrder(test1));
        System.out.println("Test 2: " + solution.levelOrder(test2));
        System.out.println("Test 3: " + solution.levelOrder(test3));
    }
}